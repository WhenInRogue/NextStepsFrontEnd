...
const CheckEmailPage = () => {
  ...
  const [sent, setSent] = useState(Boolean((location.state as { registered?: boolean } | null)?.registered));
  ...
  return (
    <AuthLayout>
      ...
      <h1 className="mt-12 font-serif text-4xl font-semibold text-ink md:text-[2.75rem]">Check your email</h1>
      <p className="mt-3 text-sm text-ink/70">
        Look for a verification link in your inbox. It expires in 24 hours. After you verify, you can sign in. If you
        need another email, send one below.
      </p>
      ...
      <form onSubmit={handleResend} className="mt-10 space-y-5">
        <div>
